...
move ./android-release-signed.apk ../../../../../output/sochitieuv2.apk
...
move ./android-armv7-release-signed.apk ../../../../../output/sochitieuv2-armv7.apk
...
move ./android-x86-release-signed.apk ../../../../../output/sochitieuv2-x86.apk
cd ../../../../../
